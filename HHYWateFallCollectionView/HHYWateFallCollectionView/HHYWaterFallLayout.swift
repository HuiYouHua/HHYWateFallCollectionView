...
@objc protocol HHYWaterFallLayoutDataSouce: class {
    ...
    @objc optional func numberOfColsInWaterfallLayout(_ layout : HHYWaterFallLayout) -> Int
}

class HHYWaterFallLayout: UICollectionViewFlowLayout {

    // MARK: 对外提供属性
    weak var dataSource : HHYWaterFallLayoutDataSouce?
...
extension HHYWaterFallLayout {
    override var collectionViewContentSize: CGSize {
        CGSize(width: 0, height: maxH + sectionInset.bottom - minimumLineSpacing)
    }
}
